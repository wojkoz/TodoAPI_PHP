 ...
 */
final class Version20210429144229 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE todo (id INT NOT NULL, user_id_id INT NOT NULL, title VARCHAR(60) NOT NULL, description VARCHAR(200) DEFAULT NULL, PRIMARY KEY(id))');
